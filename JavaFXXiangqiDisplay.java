...
public class JavaFXXiangqiDisplay implements JavaFXChessBoardDisplay {
    ...
    public void JavaFXXiangqiDisplay() {
        rowsNeeded = 10;
        columnsNeeded = 9;
    }

   Background fill1 = new Background(new BackgroundFill(Color.DARKGREY, CornerRadii.EMPTY, Insets.EMPTY));
   Background fill2 = new Background(new BackgroundFill(Color.LIGHTGREY, CornerRadii.EMPTY, Insets.EMPTY));
    ...
    public static BackgroundFill eastPlayerColor = new BackgroundFill(Color.WHITE, new CornerRadii(5.0, true), new Insets(5.0));

    /* The color of the WEST player */
    public static BackgroundFill westPlayerColor = new BackgroundFill(Color.RED, new CornerRadii(5.0, true), new Insets(5.0));

    /**
     * The color used to highlight a square
     */
    public static BackgroundFill highlightColor = new BackgroundFill(Color.BLUE, new CornerRadii(5.0, true), new Insets(5.0));
