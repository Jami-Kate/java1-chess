...
public interface ChessGame {
   ...
   *
   * @param c the ChessBoard to retrive the number of rows from
   ...
   *
   * @param c the ChessBoard to retrive the number of columns from
   * @return int The number of columns on the chess board
   */
    public int getNumColumns(ChessBoard c);
      
    /**
     * Starts the game on the ChessBoard inputted
     * 
     * @param board the ChessBoard to start the game on
     */
